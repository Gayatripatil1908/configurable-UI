...
function Home() {
  const cardStyles = [
    'bg-blue-900/40 border-blue-400 hover:bg-blue-700/60 hover:shadow-blue-400/40',
  ...
  return (
    <div className="min-h-screen py-10 px-6 bg-gray-200">
      ...
      <h2 className="text-2xl font-semibold text-center mb-8 text-black underline decoration-wavy decoration-indigo-500">
        Our Services
      </h2>
